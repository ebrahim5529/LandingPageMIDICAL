...
<head>
    ...
    <title>نظام إدارة العيادة الطبية الشاملة</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="#" class="bg-[rgb(30,64,175)] text-white px-6 py-2 rounded-lg font-medium hover:bg-[rgb(25,55,150)] transition">
                        تسجيل الدخول
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div class="text-center lg:text-right" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <a href="#" class="bg-white text-[rgb(30,64,175)] px-8 py-4 rounded-lg font-bold text-lg hover:bg-blue-50 transition shadow-lg hover:shadow-xl">
                            ابدأ الآن
                        </a>
    ...
    <section class="gradient-bg text-white py-20 px-4">
        <div class="max-w-4xl mx-auto text-center" data-aos="zoom-in" data-aos-duration="1000">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#" class="bg-white text-[rgb(30,64,175)] px-10 py-4 rounded-lg font-bold text-lg hover:bg-blue-50 transition shadow-lg hover:shadow-xl">
                    تسجيل الدخول
                </a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-gray-400 hover:text-white transition">تسجيل الدخول</a></li>
                    </ul>
                </div>
                <div>
