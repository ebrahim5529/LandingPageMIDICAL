...
<body class="bg-gray-50 scroll-smooth" dir="rtl" 
            ...
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0 flex items-center">
                        <svg class="icon-lg text-[rgb(30,64,175)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                        </svg>
                        <span class="mr-2 text-xl font-bold text-[rgb(30,64,175)]">نظام إدارة العيادة</span>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="#order-form" @click.prevent="document.querySelector('#order-form').scrollIntoView({ behavior: 'smooth' })" class="bg-[rgb(30,64,175)] text-white px-6 py-2 rounded-lg font-medium hover:bg-[rgb(25,55,150)] transition">
                        اطلب النظام
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div class="text-center lg:text-right" data-aos="fade-right" data-aos-duration="1000">
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                        نظام إدارة شامل
                        <br>
                        <span class="text-blue-200 mt-4 block">للعيادات الطبية</span>
                    </h1>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <a href="#order-form" @click.prevent="document.querySelector('#order-form').scrollIntoView({ behavior: 'smooth' })" class="bg-white text-[rgb(30,64,175)] px-8 py-4 rounded-lg font-bold text-lg hover:bg-blue-50 transition shadow-lg hover:shadow-xl">
                            اطلب النظام
                        </a>
                        <a href="#features" @click.prevent="document.querySelector('#features').scrollIntoView({ behavior: 'smooth' })" class="bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-white hover:text-[rgb(30,64,175)] transition">
                            اكتشف المزيد
                        </a>
                        <a href="https://wa.me/972568043398?text=أريد طلب نظام إدارة العيادة" target="_blank" class="bg-green-500 text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-green-600 transition shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
                ...
                <div class="hidden lg:block" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
                    <img src="{{ asset('main.PNG') }}" alt="نظام إدارة العيادة" class="w-full h-auto rounded-xl object-cover">
                </div>
                <div class="lg:hidden mt-8" data-aos="fade-up" data-aos-duration="1000">
                    <img src="{{ asset('main.PNG') }}" alt="نظام إدارة العيادة" class="w-full h-auto rounded-xl object-cover">
                </div>
            </div>
        </div>
    ...
    <section id="features" class="py-20 px-4 bg-white">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16" data-aos="fade-up" data-aos-duration="800">
                <h2 class="text-4xl font-bold text-gray-900 mb-4">الميزات الرئيسية</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="feature-card bg-white p-8 rounded-xl shadow-lg border border-gray-100" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
                    <div class="bg-blue-100 w-16 h-16 rounded-lg flex items-center justify-center mb-6">
                        <svg class="icon-lg text-[rgb(30,64,175)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">إدارة المرضى</h3>
                ...
                <div class="feature-card bg-white p-8 rounded-xl shadow-lg border border-gray-100" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                    <div class="bg-blue-100 w-16 h-16 rounded-lg flex items-center justify-center mb-6">
                        <svg class="icon-lg text-[rgb(30,64,175)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">إدارة الأطباء</h3>
                    <p class="text-gray-600 leading-relaxed">
                ...
                <div class="feature-card bg-white p-8 rounded-xl shadow-lg border border-gray-100" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
                    <div class="bg-blue-100 w-16 h-16 rounded-lg flex items-center justify-center mb-6">
                        <svg class="icon-lg text-[rgb(30,64,175)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">إدارة المواعيد</h3>
                    <p class="text-gray-600 leading-relaxed">
                ...
                <div class="feature-card bg-white p-8 rounded-xl shadow-lg border border-gray-100" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400">
                    <div class="bg-blue-100 w-16 h-16 rounded-lg flex items-center justify-center mb-6">
                        <svg class="icon-lg text-[rgb(30,64,175)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">الفواتير والدفعات</h3>
                    <p class="text-gray-600 leading-relaxed">
                ...
                <div class="feature-card bg-white p-8 rounded-xl shadow-lg border border-gray-100" data-aos="fade-up" data-aos-duration="800" data-aos-delay="500">
                    <div class="bg-blue-100 w-16 h-16 rounded-lg flex items-center justify-center mb-6">
                        <svg class="icon-lg text-[rgb(30,64,175)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">التقارير والإحصائيات</h3>
                    <p class="text-gray-600 leading-relaxed">
                ...
                <div class="feature-card bg-white p-8 rounded-xl shadow-lg border border-gray-100" data-aos="fade-up" data-aos-duration="800" data-aos-delay="600">
                    <div class="bg-blue-100 w-16 h-16 rounded-lg flex items-center justify-center mb-6">
                        <svg class="icon-lg text-[rgb(30,64,175)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">الوصفات الطبية</h3>
                    <p class="text-gray-600 leading-relaxed">
                ...
                <div class="feature-card bg-white p-8 rounded-xl shadow-lg border border-gray-100" data-aos="fade-up" data-aos-duration="800" data-aos-delay="700">
                    <div class="bg-blue-100 w-16 h-16 rounded-lg flex items-center justify-center mb-6">
                        <svg class="icon-lg text-[rgb(30,64,175)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">خدمة ردود ذكية على المرضى</h3>
                    <p class="text-gray-600 leading-relaxed">
                ...
                <div class="feature-card bg-white p-8 rounded-xl shadow-lg border border-gray-100" data-aos="fade-up" data-aos-duration="800" data-aos-delay="800">
                    <div class="bg-blue-100 w-16 h-16 rounded-lg flex items-center justify-center mb-6">
                        <svg class="icon-lg text-[rgb(30,64,175)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">حجز الكتروني للنظام</h3>
                    <p class="text-gray-600 leading-relaxed">
        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div data-aos="fade-right" data-aos-duration="1000">
                    <h2 class="text-4xl font-bold text-gray-900 mb-6">عن النظام</h2>
                    ...
                    <div class="grid grid-cols-3 gap-6">
                        <div class="text-center">
                            <div class="text-4xl font-bold text-[rgb(30,64,175)] mb-2">100%</div>
                            <div class="text-gray-600">آمن</div>
                        </div>
                        <div class="text-center">
                            <div class="text-4xl font-bold text-[rgb(30,64,175)] mb-2">24/7</div>
                            <div class="text-gray-600">متاح</div>
                        </div>
                        <div class="text-center">
                            <div class="text-4xl font-bold text-[rgb(30,64,175)] mb-2">سهل</div>
                            <div class="text-gray-600">الاستخدام</div>
                        </div>
                    </div>
                </div>
                <div class="bg-white p-8 rounded-2xl shadow-xl" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
                    <div class="space-y-6">
                        <div class="flex items-start gap-4">
                            <div class="bg-blue-100 p-3 rounded-lg">
                                <svg class="icon text-[rgb(30,64,175)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                            </div>
                            <div>
                                <h3 class="font-bold text-lg mb-2">تصميم عربي متكامل</h3>
                                <p class="text-gray-600">واجهة مستخدم عربية بالكامل مع دعم RTL كامل</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-4">
                            <div class="bg-blue-100 p-3 rounded-lg">
                            ...
                            <div>
                                <h3 class="font-bold text-lg mb-2">أمان عالي</h3>
                                <p class="text-gray-600">حماية كاملة للبيانات مع نظام صلاحيات متقدم</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-4">
                            <div class="bg-blue-100 p-3 rounded-lg">
                            ...
                            <div>
                                <h3 class="font-bold text-lg mb-2">أداء سريع</h3>
                                <p class="text-gray-600">تقنيات حديثة لضمان سرعة الاستجابة</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Order Form Section -->
    <section id="order-form" class="py-20 px-4 bg-white">
        <div class="max-w-4xl mx-auto">
            <div class="text-center mb-12" data-aos="fade-up" data-aos-duration="800">
                <h2 class="text-4xl font-bold text-gray-900 mb-4">اطلب نظام إدارة العيادة</h2>
                <p class="text-xl text-gray-600">
                    املأ النموذج وسنتواصل معك عبر واتساب لتأكيد طلبك
                </p>
            </div>
            
            <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                <form 
                    x-data="{ 
                        formData: {
                            name: '',
                        ...
                        submitForm() {
                            ...
                            const whatsappUrl = `https://wa.me/972568043398?text=${message}`;
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[rgb(30,64,175)] focus:border-transparent transition"
                                placeholder="مثال: +972 56-804-3398">
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <button 
                            type="submit"
                            class="flex-1 bg-[rgb(30,64,175)] text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-[rgb(25,55,150)] transition shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z"/>
                            </svg>
                            إرسال عبر واتساب
                        ...
                        <a 
                            href="https://wa.me/972568043398?text=مرحباً، أريد الاستفسار عن نظام إدارة العيادة" 
                            target="_blank"
                            class="flex-1 bg-green-500 text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-green-600 transition shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z"/>
                            </svg>
                            تواصل مباشر
    ...
    <section class="gradient-bg text-white py-20 px-4">
        <div class="max-w-4xl mx-auto text-center" data-aos="zoom-in" data-aos-duration="1000">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#order-form" @click.prevent="document.querySelector('#order-form').scrollIntoView({ behavior: 'smooth' })" class="bg-white text-[rgb(30,64,175)] px-10 py-4 rounded-lg font-bold text-lg hover:bg-blue-50 transition shadow-lg hover:shadow-xl">
                    اطلب النظام
                </a>
                <a href="#contact" @click.prevent="document.querySelector('#contact').scrollIntoView({ behavior: 'smooth' })" class="bg-transparent border-2 border-white text-white px-10 py-4 rounded-lg font-bold text-lg hover:bg-white hover:text-[rgb(30,64,175)] transition">
                    تواصل معنا
                </a>
                <a href="https://wa.me/972568043398?text=أريد طلب نظام إدارة العيادة" target="_blank" class="bg-green-500 text-white px-10 py-4 rounded-lg font-bold text-lg hover:bg-green-600 transition shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z"/>
                    </svg>
                    تواصل عبر واتساب
    ...
    <footer id="contact" class="bg-gray-900 text-white py-12 px-4">
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                <div>
                    <h3 class="text-2xl font-bold mb-4">نظام إدارة العيادة</h3>
    ...
    <a href="https://wa.me/972568043398?text=مرحباً، أريد الاستفسار عن نظام إدارة العيادة" 
       target="_blank" 
